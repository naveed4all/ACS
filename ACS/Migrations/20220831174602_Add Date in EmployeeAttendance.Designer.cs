...
namespace ACS.Migrations
{
    ...
    [Migration("20220831174602_Add Date in EmployeeAttendance")]
    partial class AddDateinEmployeeAttendance
    {
            ...
            modelBuilder.Entity("ACS.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 31, 22, 46, 1, 477, DateTimeKind.Local).AddTicks(1122),
                        ...
                        new
                        {
                            ItemID = 2,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 31, 22, 46, 1, 477, DateTimeKind.Local).AddTicks(1124),
                            ItemName = "ice cream"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Party", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 31, 22, 46, 1, 477, DateTimeKind.Local).AddTicks(1151),
                            PartyName = "Ashfaq"
                        },
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 31, 22, 46, 1, 477, DateTimeKind.Local).AddTicks(1153),
                            PartyName = "ismail"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Size", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SizeID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 31, 22, 46, 1, 477, DateTimeKind.Local).AddTicks(1077),
                            Name = "Medium"
                        });
                });
