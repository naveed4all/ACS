...
namespace ACS.Migrations
{
    ...
    [Migration("20220829115000_Permission RolePermission")]
    partial class PermissionRolePermission
    {
            ...
            modelBuilder.Entity("ACS.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 29, 16, 49, 59, 730, DateTimeKind.Local).AddTicks(4667),
                        ...
                        new
                        {
                            ItemID = 2,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 29, 16, 49, 59, 730, DateTimeKind.Local).AddTicks(4670),
                            ItemName = "ice cream"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Party", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 29, 16, 49, 59, 730, DateTimeKind.Local).AddTicks(4706),
                            PartyName = "Ashfaq"
                        },
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 29, 16, 49, 59, 730, DateTimeKind.Local).AddTicks(4709),
                            PartyName = "ismail"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Size", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SizeID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 8, 29, 16, 49, 59, 730, DateTimeKind.Local).AddTicks(4606),
                            Name = "Medium"
                        });
                });
