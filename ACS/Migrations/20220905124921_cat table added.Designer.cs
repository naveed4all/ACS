...
namespace ACS.Migrations
{
    ...
    [Migration("20220905124921_cat table added")]
    partial class cattableadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACS.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 5, 17, 49, 19, 688, DateTimeKind.Utc).AddTicks(8716),
                            IsActive = true,
                        ...
                        new
                        {
                            ItemID = 2,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 5, 17, 49, 19, 688, DateTimeKind.Utc).AddTicks(8719),
                            IsActive = true,
                            ItemName = "ice cream"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Party", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 5, 17, 49, 19, 688, DateTimeKind.Utc).AddTicks(8757),
                            IsActive = true,
                            PartyName = "Ashfaq"
                        },
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 5, 17, 49, 19, 688, DateTimeKind.Local).AddTicks(8765),
                            IsActive = true,
                            PartyName = "ismail"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Size", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SizeID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 5, 17, 49, 19, 688, DateTimeKind.Utc).AddTicks(8674),
                            IsActive = true,
                            Name = "Medium"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.StockOutBill", b =>
                {
                    b.Property<int>("StockOutBillID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StockOutBillID"), 1L, 1);
            ...
            modelBuilder.Entity("ACS.Models.StockOut", b =>
                {
                    ...
                    b.HasOne("ACS.Models.StockOutBill", "StockOutBill")
                        .WithMany("StockOutRecords")
                        .HasForeignKey("StockOutBillID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
