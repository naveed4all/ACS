...
namespace ACS.Migrations
{
    ...
    [Migration("20220902191131_inventory table changes")]
    partial class inventorytablechanges
    {
            ...
            modelBuilder.Entity("ACS.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 3, 0, 11, 29, 890, DateTimeKind.Utc).AddTicks(5174),
                            IsActive = true,
                        ...
                        new
                        {
                            ItemID = 2,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 3, 0, 11, 29, 890, DateTimeKind.Utc).AddTicks(5178),
                            IsActive = true,
                            ItemName = "ice cream"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Party", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 3, 0, 11, 29, 890, DateTimeKind.Utc).AddTicks(5205),
                            IsActive = true,
                            PartyName = "Ashfaq"
                        },
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 3, 0, 11, 29, 890, DateTimeKind.Local).AddTicks(5213),
                            IsActive = true,
                            PartyName = "ismail"
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Size", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SizeID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 3, 0, 11, 29, 890, DateTimeKind.Utc).AddTicks(5128),
                            IsActive = true,
                            Name = "Medium"
                        });
                });
