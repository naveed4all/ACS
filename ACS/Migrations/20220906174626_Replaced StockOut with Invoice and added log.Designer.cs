...
namespace ACS.Migrations
{
    ...
    [Migration("20220906174626_Replaced StockOut with Invoice and added log")]
    partial class ReplacedStockOutwithInvoiceandaddedlog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACS.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("ACS.Models.InventoryPartyLog", b =>
                {
            ...
            modelBuilder.Entity("ACS.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1460),
                            IsActive = true,
                            ItemName = "Cold Drinks",
                            UpdatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1444)
                        },
                        new
                        {
                            ItemID = 2,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1464),
                            IsActive = true,
                            ItemName = "ice cream",
                            UpdatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1462)
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Party", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1502),
                            IsActive = true,
                            PartyName = "Ashfaq",
                            UpdatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1499)
                        },
                        new
                        {
                            PartyID = 2,
                            ...
                            Contact = "sdasd",
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1506),
                            IsActive = true,
                            PartyName = "ismail",
                            UpdatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1506)
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.PartyLedger", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClosingBalance = 0.0,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1545),
                            IsActive = true,
                            PartyID = 1,
                            TodayCredit = 50000.0,
                            TodayDebit = 10000.0,
                            UpdatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1541)
                        },
                        new
                        {
                            PartyLedgerID = 2,
                            ClosingBalance = 0.0,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1548),
                            IsActive = true,
                            PartyID = 2,
                            TodayCredit = 0.0,
                            TodayDebit = 0.0,
                            UpdatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1547)
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Size", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SizeID = 1,
                            CreatedByUserID = 1,
                            CreatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1391),
                            IsActive = true,
                            Name = "Medium",
                            UpdatedDateTime = new DateTime(2022, 9, 6, 22, 46, 25, 314, DateTimeKind.Utc).AddTicks(1382)
                        });
                });
            ...
            modelBuilder.Entity("ACS.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("ACS.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("ACS.Models.Inventory", null)
                        .WithMany("Invoices")
                        .HasForeignKey("InventoryID");
            ...
            modelBuilder.Entity("ACS.Models.StockOut", b =>
                {
                    ...
                    b.HasOne("ACS.Models.Party", null)
                        .WithMany("StockOuts")
                        .HasForeignKey("PartyID");
            ...
            modelBuilder.Entity("ACS.Models.Transaction", b =>
                {
                    b.HasOne("ACS.Models.Category", "Category")
                        .WithMany()
